...
import { useCopyClipboard } from "@/lib/copyClipboard";
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder="Elige el tipo de elemento" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
                    ...
                    <SelectItem value="Targeta">Targeta</SelectItem>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <div className="flex flex-row items-start space-x-3 space-y-0 p-3">
                  <FormControl>
                    <Checkbox
                      checked={field.value}
